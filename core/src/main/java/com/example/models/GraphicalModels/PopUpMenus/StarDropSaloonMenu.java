...
import com.example.models.stores.StarDropSaloon;

import java.awt.*;

public class StarDropSaloonMenu extends PopUpMenu {
    private static final float WIDTH = 800f;
    private static final float HEIGHT = 800f;
    private static final float PADDING = 10f;

    private final StarDropSaloon store;
    private Table dynamicContentTable;
    private com.badlogic.gdx.scenes.scene2d.ui.Label messageLabel;

    public StarDropSaloonMenu(Skin skin, String title, Runnable onHideCallback, StarDropSaloon store) {
