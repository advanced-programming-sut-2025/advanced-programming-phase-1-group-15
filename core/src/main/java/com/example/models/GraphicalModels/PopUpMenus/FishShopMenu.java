...
import com.example.models.stores.FishShop;

import java.awt.*;

public class FishShopMenu extends PopUpMenu {
    private static final float WIDTH = 800f;
    private static final float HEIGHT = 800f;
    private static final float PADDING = 10f;

    private final FishShop store;
    private Table dynamicContentTable;
    private com.badlogic.gdx.scenes.scene2d.ui.Label messageLabel;

    public FishShopMenu(Skin skin, String title, Runnable onHideCallback, FishShop store) {
