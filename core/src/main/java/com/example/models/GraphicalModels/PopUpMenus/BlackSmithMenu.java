...
import com.example.models.stores.Blacksmith;

import java.awt.*;

public class BlackSmithMenu extends PopUpMenu {
    private static final float WIDTH = 800f;
    private static final float HEIGHT = 800f;
    private static final float PADDING = 10f;

    private final Blacksmith store;
    private Table dynamicContentTable;
    private com.badlogic.gdx.scenes.scene2d.ui.Label messageLabel;

    public BlackSmithMenu(Skin skin, String title, Runnable onHideCallback, Blacksmith store) {
