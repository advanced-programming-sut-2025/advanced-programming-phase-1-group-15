...
public enum AnimalType {
    ...
    DINOSAUR(AreaType.COOP, 14000, 7,
    ...
    public final AreaType maintenance;
    ...
    AnimalType(AreaType maintenance,
                int price,
                int period,
