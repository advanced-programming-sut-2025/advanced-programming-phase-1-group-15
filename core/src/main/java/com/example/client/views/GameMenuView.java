...
//                if(ClientApp.user.getCurrentGame() == null) {
//                    switchToNewGameUI();
//                }
//                else {
...
//        });
    ...
    private void createNewGamePanel() {
        ...
        ArrayList<User> users = new ArrayList<>(); users.add(ClientApp.user);
        ArrayList<Player> players = new ArrayList<>(); players.add(new Player(ClientApp.user));
    ...
    private void createChooseMapPanel(ArrayList<Player> players) {
        ...
        startButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                ClientApp.currentGame = newGame; ClientApp.recentGames.add(newGame);
